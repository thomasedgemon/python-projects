...
#NEED FUNCTION FOR ADDING TO CSV FILE

#NEED FUNCTION FOR CALLING CSV FILE 


option = input("what are we doing today? 1 for password generation, 2 for encryption, 3 for decryption: ")
